...
class CalculateLabelsCorrelationWithFTest():
    ...
    def get(self, y: Any):
        ...
        f_tested_label_pairs = self.calculate_f_test_for_all_label_pairs(labels_count, y)
    ...
    def calculate_f_test_for_all_label_pairs(self, labels_count: int, y: Any) -> List[Dict[str, Any]]:
        results = []
    ...
    def get_data_frame_of_correlated_labels(self, labels_count: int, f_test_results: List[Dict[str, Any]]) -> pd.DataFrame:
